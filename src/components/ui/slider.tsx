  ...
  return (
    <SliderPrimitive.Root
      ...
      className={cn(
        ...
        // removed the data-[disabled]:opacity-50 from above class
        className
      )}
      {...props}
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          ...
          // change the above bg color from muted - gray  
        )}
      >
        <SliderPrimitive.Range
          ...
          className={cn(
            ...
            //changed the above background color from primary to green
          )}
        />
      </SliderPrimitive.Track>
